...
from lexicon.data import CATEGORIES, DOCUMENTS_BY_KEY
from states.states import Auth, Login, ResetPassword, Register, FillDocument, AskQuestion
from documents.docgen import generate_docx_from_template
from aiogram.types import Message, CallbackQuery, BufferedInputFile, FSInputFile, ErrorEvent

router = Router()
config: Config = load_config()

LAWYER_GROUP_ID=config.chat.lawyer_group_id
